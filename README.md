...
* About page explaining what Quinn is and the process of using it (**in progress 85% done**)
...
* A recommended product page, including product name, description, price, image and a link to view on product e-commerce site (**in progress 90% done**)
* Go back to take the survey button for users to search for more products (**completed**)
